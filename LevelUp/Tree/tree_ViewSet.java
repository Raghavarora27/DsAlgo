...
public class tree_ViewSet {
  ...
  public static ArrayList<ArrayList<Integer>> BottomOrderValue(TreeNode root) {
    ArrayList<ArrayList<Integer>> ans = new ArrayList<>();
    if (root == null) return ans;
    ...
    for (int i = 0; i < width; i++) hlevel.add(-1);
  ...
  public static ArrayList<ArrayList<Integer>> DiagonalOrder(TreeNode root) {
    ...
    while (que.size() != 0) {
      ...
      while (size-- > 0) {
        ...
        ans.get(vl).add(node.val);
        if (node.left != null) que.addLast(new vpair(node.left, vl - 1));
        if (node.right != null) que.addLast(new vpair(node.right, vl));
      }
    }
    return ans;
  }

  public static ArrayList<ArrayList<Integer>> DigonalOrder_geeks(
    TreeNode root
  ) {
    ArrayList<ArrayList<Integer>> ans = new ArrayList<>();
    if (root == null) return ans;
  ...
  public static ArrayList<ArrayList<Integer>> VerticalOrder_ii(TreeNode root) {
    ...
    while (que.size() != 0) {
      ...
      while (size-- > 0) {
        ...
        ans.get(vl).add(node.val);
        if (node.left != null) que.add(new v2pair(node.left, hl + 1, vl - 1));
        if (node.right != null) que.add(new v2pair(node.right, hl + 1, vl + 1));
      }
    }
